...
<TABLE ON CHAIN METRICS TABLE>

<TABLE Public Endpoints>
<TABLE DOWNLODS Download genesis / Download Addrbook / Download Snapshot>




(https://preview.validatus.com/docs/networks/celestia#public-endpoints)


[](https://celestia.org/)[](https://t.me/CelestiaCommunity)[](https://twitter.com/CelestiaOrg)[](https://github.com/celestiaorg/celestia-node)
